...
require("./setup"); // Import setup for global test hooks
// Create test app
...
const authHandler = (0, node_1.toNodeHandler)(auth);
...
describe('Auth Service', () => {
    ...
    describe('POST /auth/sign-out', () => {
        ...
        beforeEach(async () => {
            ...
            const signupResponse = await (0, supertest_1.default)(app)
                .post('/auth/sign-up/email')
                .send({
            ...
            if (cookies && Array.isArray(cookies)) {
                const sessionCookie = cookies.find((cookie) => cookie.startsWith('auth.session'));
                if (sessionCookie) {
